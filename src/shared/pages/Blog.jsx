...
const Blog = () => {
    return (
        <div className="App">
            <div ref={ref}>
                <div className='grid md:grid-cols-2 gap-2 ml-4 mr-4 md:mt-4 mt-2'>
            ...
            <Pdf targetRef={ref} filename="code-example.pdf">
                {({ toPdf }) => <button className='text-blue-400 underline md:ml-80  mt-2 md:pl-80  ' onClick={toPdf}>Generate Pdf</button>}
            </Pdf>
        </div>
    );
};
